    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "4rem 2.5rem", flex: 1, display: "grid", gridTemplateColumns: "1fr 2fr", gap: "4rem", alignItems: "start", borderBottom: "0.5px solid var(--border)" }}>
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem", borderTop: "0.5px solid var(--border)", paddingTop: "2rem" }}>
            {[
              { label: "Based", value: "Kingston, Jamaica" },
              { label: "Studio", value: "Soul Culture" },
              { label: "Availability", value: "Open for work" },
              { label: "Education", value: "UTech Jamaica — BA Communications Arts & Technology" },
            ].map(({ label, value }) => (
              <div key={label}>
