...
function SwatchRow() {
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", borderBottom: "0.5px solid var(--border)" }}>
...
export default function SeabornClubPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <div style={{ borderBottom: "0.5px solid var(--border)", background: "#000", display: "flex", justifyContent: "center", padding: "3rem 2.5rem" }}>
